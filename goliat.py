...
# Rectangular Rounded bar dimensions:
RBAR_B = 40. * SCALE # Base
RBAR_H = 40. * SCALE # Height
RBAR_R = 10. * SCALE # Radius of the corners (it is rounded)
RBAR_T =  4. * SCALE # inside thickness of the bar. The bar is hollow
...
h_framez_00 = comps.RectRndBar (Base = RBAR_B, Height = RBAR_H,
...
framey_l = FRAME_L - 2*RBAR_B
print "framey_l "  + str(framey_l) + ' has to be 1500'
h_framey_00 = comps.RectRndBar (Base = RBAR_B, Height = RBAR_H,
...
h_framex_00 = comps.RectRndBar (Base = RBAR_B, Height = RBAR_H,
...
rody_00 = fcfun.addCyl_pos (r = RODY_R, h= framey_l, name='rody_00',
                            axis = 'y', h_disp =  -(frame_posy-RBAR_B/2.))
...
h_gantryz_00 = comps.RectRndBar (Base = RBAR_B, Height = RBAR_H,
...
gantry_posy = GANTRY_L/2. - RBAR_B/2.
